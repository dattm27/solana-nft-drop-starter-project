...
const CandyMachine = ({ walletAddress }) => {
  ...
  const getProvider = () => {
    const rpcHost = process.env.REACT_APP_SOLNA_RPC_HOST;
  ...
  const getCandyMachineState = async () => {
    ...
    const itemAvailable = candyMachine.data.itemsAvailable.toNumber();
    const itemsRedeemed = candyMachine.itemsRedeemed.toNumber();
    const itemsRemaining = itemAvailable - itemsRedeemed;
    ...
    console.log({itemAvailable, itemsRedeemed, itemsRemaining, goLiveDate, goLiveDateTimeString});
